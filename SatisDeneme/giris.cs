            ...
            if (tkullaniciadi.Text != "" && tsifre.Text != "")
            {
                try
                {
                    using (var db = new MarketDBEntities())
                    {
                        if (db.Kullanici.Any())
                        {
                            var bak = db.Kullanici.Where(x => x.Kullanici_adi == tkullaniciadi.Text && x.Sifre == tsifre.Text).FirstOrDefault();
                            ...
                            if (bak != null)
                            {
                                ...
                                f.bUrunGiris.Enabled = (bool)bak.UrunGırıs;
